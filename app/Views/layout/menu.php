...
<li><a class="nav-link" href="<?= site_url("main_menu")?>"><i class="far fa-square"></i> <span>Main Menu</span></a></li>
...
<li><a class="nav-link" href="<?= site_url("main_menu")?>"><i class="far fa-square"></i> <span>Cek Berkas</span></a></li>
<li class="nav-item dropdown">
